...
1.  Clone specific repository or download the files.
2.  Open `index.html` in any modern web browser.

## 🛠️ Technologies Used

-   **HTML5**: Structure and semantics.
-   **CSS3**: Animations, Flexbox, Grid, and 3D transforms.
-   **JavaScript (Vanilla)**: Logic for interactions, navigation, and canvas rendering.

## 📷 Gallery Note

The gallery is designed to load images from the `img/` folder. If images are missing, it gracefully degrades to placeholders or uses external avatars.

## 📝 License

This project is personal and created with ❤️ for a best friend. Feel free to use it as inspiration for your own projects!
